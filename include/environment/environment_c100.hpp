...
//      vis->setDesiredFPS(30.0);
   ...
   // jointDgain.setZero(); jointDgain.tail(12).setConstant(0.2);
   // anymal_->setPdGains(jointPgain, jointDgain);
   // anymal_->setGeneralizedForce(Eigen::VectorXd::Zero(18));
  }
...
//    }
  ...
  virtual void integrate() {
   ...
   //  //mgeisert
   //  Eigen::VectorXd jointPosition(19);
   //  jointPosition.setZero(); jointPosition.tail(12) = jointPositionTarget_;
   //  anymal_->setPdTarget(jointPosition, jointPosition.tail(18)*0.);
