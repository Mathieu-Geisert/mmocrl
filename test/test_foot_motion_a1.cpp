...
int main(int argc, char *argv[]) {
  ...
  std::string urdf_path = "/home/pshah/Applications/mmocrl/rsc/robot/a1/urdf/a1.urdf";
  std::string actuator_network_path = "/home/pshah/Applications/mmocrl/rsc/actuator/C100/seaModel_2500.txt";
  ...
  NoisyState robotState(a1, &rn);
  FootMotionGenerator footMotion(&a1Params, &robotState, 2, 0.2, 0.0025);
